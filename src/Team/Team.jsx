...
import PatrickAchkar_img from "./Image/PatrickAchkar.jpg";
  ...
  return (
    <div id="Team">
      ...
      <Row>
        <Col sm="12">
          <Member
            name="Patrick Al-Achkar"
            text="Au cours des dernières années, mes recherches personnelles, mes formations diverses et mes expériences de travail comme entraîneur m’ont aidé à élargir mes compétences et à enrichir ma pratique en ostéopathie. L’expérience acquise m’a amené à mieux comprendre les différentes composantes de la santé en général, physique et mentale, et m’ont donné la motivation d’aider le plus grand nombre de personnes à atteindre et à maintenir santé et bien-être. Passionné de sport et d’anatomie, je suis là aussi pour ceux qui veulent devenir des athlètes aussi bien que pour les athlètes accomplis.C’est avec cette volonté d’aider que j’ai fondé PosturoPlus. Et je veux m’actualiser avec d’autres professionnels la philosophie et les valeurs que j’ai formulées avec conviction pour Posturo Plus."
            image={PatrickAchkar_img}
          />
        </Col>
        <Col sm="12">
          <Member
